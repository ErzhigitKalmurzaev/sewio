...
import { getPartyList, getWorkById, patchAcceptOperation } from '../../../../store/foreman/order';
...
const EditAccWork = () => {
  ...
  const { work, work_status, parties, operations_list, staff_list } = useSelector(state => state.foreman_order);
